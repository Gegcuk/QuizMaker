...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quizzes_created_at ON quizzes(created_at)', 'SELECT 1');
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quizzes_difficulty ON quizzes(difficulty)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quizzes_is_deleted ON quizzes(is_deleted)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quizzes_category_id ON quizzes(category_id)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quizzes_creator_id ON quizzes(creator_id)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quizzes_title ON quizzes(title)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quizzes_description_prefix ON quizzes(description(191))', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quiz_tags_quiz_id ON quiz_tags(quiz_id)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_quiz_tags_tag_id ON quiz_tags(tag_id)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_tags_name ON tags(tag_name)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_categories_name ON categories(category_name)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @sql := IF(@exists = 0, 'CREATE INDEX idx_users_username ON users(username)', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
