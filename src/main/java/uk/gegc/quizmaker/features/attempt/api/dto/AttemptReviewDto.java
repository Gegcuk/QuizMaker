...
@Schema(name = "AttemptReviewDto", description = "Complete review of a finished attempt with user answers and correct answers")
...
public record AttemptReviewDto(
        ...
        @Schema(description = "Detailed review of each answer with user responses and correct answers")
