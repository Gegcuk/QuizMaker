...
@Schema(name = "GenerateQuizFromTextRequest", description = "Request to generate quiz from plain text in one operation")
public record GenerateQuizFromTextRequest(
        @Schema(description = "Plain text content to generate quiz from", example = "Machine learning is a subset of artificial intelligence...")
        ...
        @Max(value = 300000, message = "Max chunk size must not exceed 100000 characters")
