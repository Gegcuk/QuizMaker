...
@Schema(description = "Full article payload with structured content, CTAs, and metadata")
public record ArticleDto(
        @Schema(description = "Stable article identifier", example = "art_123")
        UUID id,
        ...
        @Schema(description = "Author info", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        @Schema(description = "Secondary CTA block", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        @Schema(description = "Revision for cache revalidation and optimistic concurrency", example = "3")
        Integer revision
) {
}
